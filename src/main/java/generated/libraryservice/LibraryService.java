...
public interface LibraryService {
    ...
    @Action(input = "http://LibraryService/extendLoan", output = "http://LibraryService/LibraryService/extendLoanResponse", fault = {
        @FaultAction(className = LoanExtensionException.class, value = "http://LibraryService/LibraryService/extendLoan/Fault/LoanExtensionException")
    })
